...
class AdsMapperTest {
    ...
    public static final String FILE_PATH = "Some filePath";
    ...
    void toAdsDtoTest() {
        ...
        Assertions.assertThat(adsDto.getImage()).isEqualTo(FILE_PATH);
    }
    ...
    void toFullAdsDtoTest() {
        ...
        Assertions.assertThat(fullAdsDto.getImage()).isEqualTo(FILE_PATH);
    }
